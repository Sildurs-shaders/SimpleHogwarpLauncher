...
@echo Injecting Hogwarp and launching the game..
	...
	move "%LauncherPath%Phoenix\Binaries\Win64\version.dll" "%LauncherPath%..\Phoenix\Binaries\Win64\"
 	move "%LauncherPath%Phoenix\Content\Paks\~mods\HogWarp.pak" "%LauncherPath%..\Phoenix\Content\Paks\~mods\"
	move "%LauncherPath%Phoenix\Content\Paks\~mods\HogWarp.ucas" "%LauncherPath%..\Phoenix\Content\Paks\~mods\"
	move "%LauncherPath%Phoenix\Content\Paks\~mods\HogWarp.utoc" "%LauncherPath%..\Phoenix\Content\Paks\~mods\"
